            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        nameValuePairs.add(new BasicNameValuePair("Type", "place"));
                       /* if(MainActivity.lat.length()==0)
                            Toast.makeText(getContext(), "Error Fetching location",
                                    Toast.LENGTH_LONG).show();*/
                       if(MainActivity.lat.length()==0) {
                           MainActivity.lat = "-122.0840";
                            MainActivity.lang="37.4220";
                        ...
                        nameValuePairs.add(new BasicNameValuePair("long",MainActivity.lang));
                    ...
                    try {
                       ...
                       myAdapter =  new CustomAdapter(getActivity().getApplicationContext(),al,"place");
                            ...
                            public void run() {
                                ...
                                btnNext.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        ListAdapter myAdapter2 =  new CustomAdapter(getActivity().getApplicationContext(),jarr,"place");
                                        ...
                                        if(PlaceFragment.mk>=jsonArr.size())
                                            btnNext.setEnabled(false);
                                        else
