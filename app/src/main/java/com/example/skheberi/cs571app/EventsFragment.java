            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                     ...
                     myAdapter =  new CustomAdapter(getActivity().getApplicationContext(),al,"events");
                            ...
                            public void run() {
                                ...
                                btnNext.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        ListAdapter myAdapter2 =  new CustomAdapter(getActivity().getApplicationContext(),jarr,"events");
                                        listView.setAdapter(myAdapter2);
                                        k+=10;
                                        EventsFragment.mk+=10;

                                        if(EventsFragment.mk<=10)
                                            btnPrev.setEnabled(false);
                                        else
                                            btnPrev.setEnabled(true);
                                        if(EventsFragment.mk>=jsonArr.size())
                                            btnNext.setEnabled(false);
                                        else
