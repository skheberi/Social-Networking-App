...
public class PageFragmentFav extends Fragment {
    static int mk = 10;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_pagefav, container, false);
      ...
      user = new ArrayList<JsonObject>();
            ...
            String strJson = sharedPreferences.getString("page","0");
