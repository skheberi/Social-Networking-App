...
public class PlaceFragmentFav extends Fragment {
    static int mk = 10;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_placefav, container, false);
        ...
        try {
           ...
           user = new ArrayList<JsonObject>();
            ...
            String strJson = sharedPreferences.getString("place","0");
