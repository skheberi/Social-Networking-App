                ...
                public void run() {
                    ...
                    try {
                       ...
                       final int x= Math.min(10,jsonArr.size());
                        ...
                        myAdapter =  new CustomAdapter(getActivity().getApplicationContext(),al,"page");
                            ...
                            public void run() {
                                ...
                                btnNext.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        ListAdapter myAdapter2 =  new CustomAdapter(getActivity().getApplicationContext(),jarr,"page");
                                        ...
                                        if(PageFragment.mk>=jsonArr.size())
                                            btnNext.setEnabled(false);
                                        else
